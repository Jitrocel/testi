...
const marker_c_budejovice = L.marker([49, 14.5]).addTo(map); // San Francisco, CA coordinates
...
marker_c_budejovice.bindPopup("<b>Hello!</b><br>České Budějovice").openPopup();
